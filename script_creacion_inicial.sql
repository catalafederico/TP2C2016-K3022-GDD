...
BEGIN
	...
	--Se migran los pacientes de la tabla Maestra
	INSERT INTO [3FG].AFILIADOS(ID_USUARIO,ID_PLAN, CANT_BONOS_UTILIZADOS)
	SELECT DISTINCT ID_USUARIO,Plan_Med_Codigo,0 
...
INSERT INTO [3FG].AGENDA(ID_USUARIO,ID_ESPECIALIDAD,DIA_ATENCION,INICIO_ATENCION,FIN_ATENCION)
VALUES(99999,9999,'DOMINGO','08:00:00 AM','06:00:00 PM')
